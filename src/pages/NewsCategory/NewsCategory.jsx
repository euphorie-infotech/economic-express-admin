...
const NewsCategory = () => {
  ...
  const onFormSubmit = (formVsibility) => {
    setVisibility(formVsibility);
  };
  return (
    <>
      <div className="w-full py-5 px-10 border-b border-slate-500 flex justify-between items-center">
